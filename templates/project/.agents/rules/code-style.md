...
- Use explicit namespace resolution (`pkg::function`) where appropriate.
- Follow the tidyverse style guide where applicable.
- Leverage `renv` to maintain reproducible project dependencies.
