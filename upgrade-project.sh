...
FILES_TO_SYNC=(
    ...
    "templates/docs/conventions.md:docs/conventions.md:true"
    "templates/docs/data-rules.md:docs/data-rules.md:true"
    "templates/docs/modeling-rules.md:docs/modeling-rules.md:true"
    "templates/docs/context-management.md:docs/context-management.md:true"
    "templates/docs/session-protocols.md:docs/session-protocols.md:true"
    "templates/docs/testing-requirements.md:docs/testing-requirements.md:true"
    "templates/docs/security-rules.md:docs/security-rules.md:true"
    "templates/docs/domain-rules.md:docs/domain-rules.md:true"
    "templates/docs/safety-policies.md:docs/safety-policies.md:true"
