...
- **Global Config & Skills**: Installs a core profile of 12 global skills and a cross-platform statusline script directly to your machine's global configuration (`~/.gemini/antigravity-cli/`).
