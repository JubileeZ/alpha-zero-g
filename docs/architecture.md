# Architecture & Layering Rules — Alpha-Zero-G

This document maps out the system architecture, rule priority execution layers, and file layout guidelines of the Alpha-Zero-G developer harness.
...
| `/docs/design` | Detailed software and math designs (ADRs) |
| `/src` | Core implementation code (modules, analysis classes, solvers) |
| `/notebooks` | Jupyer notebooks, scratch calculations, and py:percent sources |
